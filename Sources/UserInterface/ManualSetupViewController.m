...
{
    UITableViewCell *cell = [self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:2
                                                                                     inSection:0]];
    return (UITextField *) [cell viewWithTag:2];
}
...
//	NSLog(@" _customServerURL     = %@", _customServerURL);
    ...
    if (_customServerEnabled && [_customServerURL length] != 0)
    {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:_customServerURL
                                                  forKey:@"customServerURL"];
        ...
        case 1:
        {
            switch (indexPath.row)
            {
                case 0:
                {
                    ...
                    [schwitch addTarget:self
                                 action:@selector(customServerSwitchChangedValue:)
                ...
                case 1:
                {
                    ...
                    [textField addTarget:self
                                  action:@selector(customServerTextFieldChangedValue:)
                        forControlEvents:UIControlEventValueChanged];
                    break;
                }
            }
