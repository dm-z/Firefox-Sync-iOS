...
didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  [CryptoUtils testHmacSha256];
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleVersion"]
                                             forKey:@"FFH_VERS"];
...
- (void)reportErrorWithInfo:(NSDictionary *)errInfo
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[errInfo objectForKey:@"title"]
                                                    message:[errInfo objectForKey:@"message"]
                                                   delegate:nil
...
- (void)reportAuthErrorWithMessage:(NSDictionary *)errInfo
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[errInfo objectForKey:@"title"]
                                          ...
                                          otherButtonTitles:NSLocalizedString(@"Sign In", @"re-authenticate"),
                                                            nil];
    [alert show];
    [alert release];
}
                                ...
                                duration:(NSTimeInterval)duration
{
    ...
    [[appDelegate settings] willRotateToInterfaceOrientation:toInterfaceOrientation
                                                    duration:duration];
    [[appDelegate searchResults] willRotateToInterfaceOrientation:toInterfaceOrientation
                                                         duration:duration];
    [[appDelegate tabBrowser] willRotateToInterfaceOrientation:toInterfaceOrientation
                                                      duration:duration];
